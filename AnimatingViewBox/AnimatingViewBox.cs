    ...
    public class AnimatingViewBox : Decorator
    {
        ...
        public static readonly DependencyProperty StretchDirectionProperty =
            DependencyProperty.Register("StretchDirection", typeof(StretchDirection), typeof(AnimatingViewBox),
                                        new FrameworkPropertyMetadata(StretchDirection.Both, FrameworkPropertyMetadataOptions.AffectsMeasure), StretchDirectionIsValid);

        public static readonly DependencyProperty EasingFunctionProperty =
            DependencyProperty.Register("EasingFunction", typeof(IEasingFunction), typeof(AnimatingViewBox), new PropertyMetadata(new BackEase() { EasingMode = EasingMode.EaseInOut, Amplitude = 0.2 }));

        public static readonly DependencyProperty ResizeXDurationProperty =
            DependencyProperty.Register("ResizeXDuration", typeof(Duration), typeof(AnimatingViewBox), new PropertyMetadata(new Duration(new TimeSpan(0, 0, 0, 0, 450))));

        public static readonly DependencyProperty ResizeYDurationProperty =
            DependencyProperty.Register("ResizeYDuration", typeof(Duration), typeof(AnimatingViewBox), new PropertyMetadata(new Duration(new TimeSpan(0, 0, 0, 0, 300))));
        ...
        public Duration ResizeYDuration
        {
            get { return (Duration)GetValue(ResizeYDurationProperty); }
            set { SetValue(ResizeYDurationProperty, value); }
        }

        public Duration ResizeXDuration
        {
            get { return (Duration)GetValue(ResizeXDurationProperty); }
            set { SetValue(ResizeXDurationProperty, value); }
        }
        ...
        protected override Size ArrangeOverride(Size arrangeSize)
        {
            ...
            if (internalChild != null)
            {
                ...
                else
                {
                    ...
                    scaleXAnimation.Duration = ResizeXDuration;
                    scaleYAnimation.Duration = ResizeYDuration;
